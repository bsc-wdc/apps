...
APP_PATH=/gpfs/home/bsc19/bsc19234/STORAGE/examples_with_persistent_storage/wordcount_OO/src
DATASET=hpc_dataset
USERNAME=bsc_user
PASSWORD=bsc_user
...
echo "***"
$DATACLAY_TOOL NewModel $USERNAME $PASSWORD classes $APP_PATH/classes python
...
rm -rf $STUBS_PATH
mkdir -p $STUBS_PATH
$DATACLAY_TOOL GetStubs $USERNAME $PASSWORD classes $STUBS_PATH
