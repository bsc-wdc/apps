...
@binary(binary='gracebat')   # xmgrace in MN4
@task(xvg=FILE_IN,
      png=FILE_OUT)
...
if __name__=='__main__':
    ...
    # runcompss -m -d --python_interpreter=python3 ~/gromacs/src/lysozyme_in_water_onlyBinaryExecution.py ~/gromacs/config ~/gromacs/dataset ~/gromacs/output
