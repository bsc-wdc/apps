...
dockerEngine = 'DOCKER'
dockerImage = 'gromacs/gromacs' 
# ############ #
# Step 1 tasks #
# ############ #

@binary(binary='gmx', engine=dockerEngine, image=dockerImage)
...
# Step 5 tasks #
# ############ #
# constraints con 48 computing units
@binary(binary='gmx', engine=dockerEngine, image=dockerImage)   # mpi candidate
@task(em=FILE_IN,
      em_energy=FILE_OUT)
...
@binary(binary='grace', engine=dockerEngine, image='compss/grace-5.1.25')   # xmgrace in MN4
@task(xvg=FILE_IN,
      png=FILE_OUT)
...
def main(dataset_path, output_path, config_path):
    ...
    # tomar el tiempo fin - inicio instrumentar el codigo para python
    # subir el codigo hecho hasta ahora a la rama
    # enviar las aplicaciones
    # miercoles 17
...
if __name__=='__main__':
    ...
    # runcompss -m -d --python_interpreter=python3 ./lysozyme_in_water_dockerExecution.py /home/compss/gromacs/config /home/compss/gromacs/dataset /home/compss/gromacs/output
    # 