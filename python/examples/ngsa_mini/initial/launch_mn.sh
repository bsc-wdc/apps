...
execFile=${NGSA_MINI_HOME}/0_initial/src/workflow.py
appClasspath=${NGSA_MINI_HOME}/0_initial/src
appPythonpath=${NGSA_MINI_HOME}/0_initial/src
WORK_DIR=${NGSA_MINI_HOME}/0_initial/work_compss
