...
from nsdataproc.experiment_params import num_neurons,num_secs,num_bins
from nsdataproc.analysis_params import maxlag,num_surrs
import time
...
def cc_surrogate_range(fspikes, start_idx, end_idx, seed, num_neurons, num_surrs, num_bins, maxlag):
    ...
    for ni in arange(num_neurons-1):
		...
		print "Calculating correlation", ni, nj, idxrange, row
...
def ns_data_processing(fspikes, num_frags):
    ...
    return ('result_cc_originals.dat','result_cc_surrogates_conf.dat')
