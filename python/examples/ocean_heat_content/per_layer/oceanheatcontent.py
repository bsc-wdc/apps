...
@task(returns=1,
      numba='vectorize',
      numba_signature=['float32(int32, int32, float32, float32, float32)'],
...
@implement(source_class='examples-oceanheatcontent',
           method='calculate_weight_numba')
...
@task(returns=1,
      weights={Type: COLLECTION_IN, Depth: 1},
      area={Type: COLLECTION_IN, Depth: 2})
...
@implement(source_class='examples-oceanheatcontent', method='compute_ohc_cpu')
@constraint(processors=[{'ProcessorType': 'CPU', 'ComputingUnits': '1'},
                        {'ProcessorType': 'GPU', 'ComputingUnits': '1'}])
@task(returns=1,
      weights={Type: COLLECTION_IN, Depth: 1},
