...
def main():    
    ...
    csvm = CascadeSVM(kernel=args.k, C=args.c, cascade_arity=args.a, n_chunks=args.n, gamma=args.g, cascade_iterations=args.i, exec_time=e_time)
    ...
    out = [args.k, args.a, args.n, csvm._clf_params["gamma"], args.c, csvm.iterations, csvm.converged, csvm.read_time, csvm.fit_time, csvm.total_time]    
