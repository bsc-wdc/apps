...
public class SumPoints extends DataClayObject implements Serializable {
    ...
    // @task
    public SumPoints reduceCentersTask(SumPoints other) {
        for (int i = 0; i < other.getSize(); i++) {
            this.sumValue(i, other.getValue(i), other.getNumPoints(i));
        }
        return this;
    }
