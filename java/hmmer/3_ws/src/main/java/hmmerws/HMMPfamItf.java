...
public interface HMMPfamItf {
	...
	@Method(declaringClass = "hmmerws.HMMPfamImpl")
	String hmmpfam(
	...
	@Service(namespace = "http://hmmerobj.worker", name = "HmmerObjects", port = "HmmerObjectsPort")
	String scoreRatingSameDB(
