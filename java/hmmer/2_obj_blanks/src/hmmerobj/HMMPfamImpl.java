...
public class HMMPfamImpl {
    ...
    private final static String HEADER_END2 = "- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -";
    ...
    public static String hmmpfam(String hmmpfamBin,
            String commandLineArgs,
            String seqFile,
            String dbFile) throws Exception {
    ...
    // resultMerged = result1 with appended result2
    public static String mergeSameDB(String result1, String result2) throws Exception {
        int end_of_header = result2.indexOf(HEADER_END);
        if (end_of_header > -1) {
            return result1.concat(result2.substring(end_of_header + HEADER_END.length()));
        }
        return result1;
    }

    // resultMerged = resultString1 merged with resultString2
    public static String mergeSameSeq(String resultString1,
        ...
        String line1;
        while (!(line1 = file1BR.readLine()).equals(HEADER_END2)) {
            result.append(line1 + "\n");
        }
        result.append(HEADER_END2 + "\n");
        ...
        while (!line2.equals(HEADER_END2)) {
