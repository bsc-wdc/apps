...
public class HMMPfam {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Merge all the outputs sequence outputs for the same DB fragment
        for (int db = 0; db < numDBFrags; db++) {
            int neighbor = 1;
            String[] sequences = outputs[db];
            
            // TODO: Write the code of the merge using method HMMPfamImpl.mergeSameSeq
            
            	//Hint: The "sequences" array contains the output of hmmrpfam for each sequence part for a given db fragment.
            	//Use a nested loop to merge a pair of outputs and accumulate them in the first element of the array
            	//Ex: merge(sequence[0], sequence[1]) -> sequence[0]
