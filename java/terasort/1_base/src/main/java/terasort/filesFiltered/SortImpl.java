...
public class SortImpl {
    ...
    public static Fragment getFilteredFragment(String filePath, long startValue, long endValue, boolean readAll) {
        Fragment fragment = new Fragment(filePath, startValue, endValue, readAll);
        return fragment;
    }
