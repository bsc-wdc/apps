...
int execute(int argc, char **argv, CBindingCache* cache, int serializeOuts) {
	 ...
	 if(is_debug()){
		 ...
		 cout << "[C-BINDING] NumSlaves: " << argv[8] << endl;
	 }
	 int numSlaves=atoi(argv[8]);
	 if(is_debug()){
	 ...
	 case multiplyBlocksOp:
		 {
			 ...
			 arg_offset ++;
			 cout <<"[C Binding] Received value : "<< block1_filename_og << endl;
			 ...
			 if (block1_orig_id != NULL && block1_filename != NULL){ // Obtain object from cache
				 cout << "[C Binding] Managing object data id for block1 ..." << endl << flush;
				 ...
				 cout << "[C Binding] Checking if object block1 with id "<< block1_dest_id_str << " is in cache." << endl << flush;
				 bool found = cache->isInCache(block1_dest_id);
				 if (!found){
					 cout << "[C Binding] Destination id not found in cache. Checking if object block1 with id "<< block1_orig_id_str << " is in cache." << endl << flush;
					 ...
					 if (!found){
						 ...
						 if (res != 0){
							 cout << "[C Binding] Error Deserializing object block1 as "<< block1_dest_id_str <<". Deserializing object block1 from " << block1_orig_id_str << " as " << block1_dest_id_str << endl << flush;
						 ...
						 cout << "[C Binding] Object block1 has been added to the cache as " << block1_dest_id_str << " with type 0."  << endl << flush;
					 } else {  // found as origin id -> move or copy 
						 if (string(block1_pres_data) == "true"){
							 cout << "[C Binding] Copying object block1 in cache. From " << block1_orig_id << " to "<< block1_dest_id << endl << flush;
							 ...
							 cout << "[C Binding] Moving object block1 in cache. From " << block1_orig_id << " to "<< block1_dest_id << endl << flush;
							 int res = cache->moveInCache(block1_orig_id, block1_dest_id);
							 if (res != 0){
								 cerr << "[C Binding] Error copying object block1 in "<< block1_orig_id << endl << flush;
								 return res;
							 }
							 cout << "[C Binding] Object block1 has been added to the cache as" << block1_dest_id_str << " with type 0. Previous version is kept as " << block1_orig_id_str << endl << flush;
							 compss_pointer cp;
					 ...
					 block1 = (Block*)cp.pointer;
					 cout << "[C Binding] Object block1 has been read from the cache as" << block1_dest_id_str << endl << flush;
				 } //end found as dest id 
				 if (string(block1_pres_data) == "false"){
					 cache->deleteFromCache(block1_orig_id, false);
					 cout << "[C Binding] Object " << block1_orig_id_str << " has been removed from the cache." << endl << flush;
				 }
				 if (serializeOuts < 1){
					 remove(block1_dest_id);
					 cout << "[C Binding] Removed file " << block1_dest_id << endl;
				 }
			 } else { //Obtain object as file 
				 cout << "[C Binding] Data ID for parameter block1 not found in argument value. Reseting filename to " << block1_filename_og << endl << flush;
				 block1_filename = block1_filename_og ;
			 ...
			 arg_offset ++;
			 cout <<"[C Binding] Received value : "<< block2_filename_og << endl;
			 ...
			 if (block2_orig_id != NULL && block2_filename != NULL){ // Obtain object from cache
				 cout << "[C Binding] Managing object data id for block2 ..." << endl << flush;
				 ...
				 cout << "[C Binding] Checking if object block2 with id "<< block2_dest_id_str << " is in cache." << endl << flush;
				 bool found = cache->isInCache(block2_dest_id);
				 if (!found){
					 cout << "[C Binding] Destination id not found in cache. Checking if object block2 with id "<< block2_orig_id_str << " is in cache." << endl << flush;
					 ...
					 if (!found){
						 ...
						 if (res != 0){
							 cout << "[C Binding] Error Deserializing object block2 as "<< block2_dest_id_str <<". Deserializing object block2 from " << block2_orig_id_str << " as " << block2_dest_id_str << endl << flush;
						 ...
						 cout << "[C Binding] Object block2 has been added to the cache as " << block2_dest_id_str << " with type 0."  << endl << flush;
					 } else {  // found as origin id -> move or copy 
						 if (string(block2_pres_data) == "true"){
							 cout << "[C Binding] Copying object block2 in cache. From " << block2_orig_id << " to "<< block2_dest_id << endl << flush;
							 ...
							 cout << "[C Binding] Moving object block2 in cache. From " << block2_orig_id << " to "<< block2_dest_id << endl << flush;
							 int res = cache->moveInCache(block2_orig_id, block2_dest_id);
							 if (res != 0){
								 cerr << "[C Binding] Error copying object block2 in "<< block2_orig_id << endl << flush;
								 return res;
							 }
							 cout << "[C Binding] Object block2 has been added to the cache as" << block2_dest_id_str << " with type 0. Previous version is kept as " << block2_orig_id_str << endl << flush;
							 compss_pointer cp;
					 ...
					 block2 = (Block*)cp.pointer;
					 cout << "[C Binding] Object block2 has been read from the cache as" << block2_dest_id_str << endl << flush;
				 } //end found as dest id 
				 if (string(block2_pres_data) == "false"){
					 cache->deleteFromCache(block2_orig_id, false);
					 cout << "[C Binding] Object " << block2_orig_id_str << " has been removed from the cache." << endl << flush;
				 }
				 if (serializeOuts < 1){
					 remove(block2_dest_id);
					 cout << "[C Binding] Removed file " << block2_dest_id << endl;
				 }
			 } else { //Obtain object as file 
				 cout << "[C Binding] Data ID for parameter block2 not found in argument value. Reseting filename to " << block2_filename_og << endl << flush;
				 block2_filename = block2_filename_og ;
			 ...
			 arg_offset ++;
			 cout <<"[C Binding] Received value : "<< block3_filename_og << endl;
			 ...
			 if (block3_orig_id != NULL && block3_filename != NULL){ // Obtain object from cache
				 cout << "[C Binding] Managing object data id for block3 ..." << endl << flush;
				 ...
				 cout << "[C Binding] Checking if object block3 with id "<< block3_dest_id_str << " is in cache." << endl << flush;
				 bool found = cache->isInCache(block3_dest_id);
				 if (!found){
					 cout << "[C Binding] Destination id not found in cache. Checking if object block3 with id "<< block3_orig_id_str << " is in cache." << endl << flush;
					 ...
					 if (!found){
						 ...
						 if (res != 0){
							 cout << "[C Binding] Error Deserializing object block3 as "<< block3_dest_id_str <<". Deserializing object block3 from " << block3_orig_id_str << " as " << block3_dest_id_str << endl << flush;
						 ...
						 cout << "[C Binding] Object block3 has been added to the cache as " << block3_dest_id_str << " with type 0."  << endl << flush;
					 } else {  // found as origin id -> move or copy 
						 if (string(block3_pres_data) == "true"){
							 cout << "[C Binding] Copying object block3 in cache. From " << block3_orig_id << " to "<< block3_dest_id << endl << flush;
							 ...
							 cout << "[C Binding] Moving object block3 in cache. From " << block3_orig_id << " to "<< block3_dest_id << endl << flush;
							 int res = cache->moveInCache(block3_orig_id, block3_dest_id);
							 if (res != 0){
								 cerr << "[C Binding] Error copying object block3 in "<< block3_orig_id << endl << flush;
								 return res;
							 }
							 cout << "[C Binding] Object block3 has been added to the cache as" << block3_dest_id_str << " with type 0. Previous version is kept as " << block3_orig_id_str << endl << flush;
							 compss_pointer cp;
					 ...
					 block3 = (Block*)cp.pointer;
					 cout << "[C Binding] Object block3 has been read from the cache as" << block3_dest_id_str << endl << flush;
				 } //end found as dest id 
				 if (string(block3_pres_data) == "false"){
					 cache->deleteFromCache(block3_orig_id, false);
					 cout << "[C Binding] Object " << block3_orig_id_str << " has been removed from the cache." << endl << flush;
				 }
				 if (serializeOuts < 1){
					 remove(block3_dest_id);
					 cout << "[C Binding] Removed file " << block3_dest_id << endl;
				 }
			 } else { //Obtain object as file 
				 cout << "[C Binding] Data ID for parameter block3 not found in argument value. Reseting filename to " << block3_filename_og << endl << flush;
				 block3_filename = block3_filename_og ;
			 ...
			 cout << "[C Binding] Calling function (null).multiplyBlocks" << endl << flush;
			 multiplyBlocks(block1, block2, block3);
			 cout << "[C Binding] Execution of function (null).multiplyBlocks finished." << endl << flush;

			 if (serializeOuts){
				 cout << "[C Binding] Object will be serialized as output." << endl << flush;
			 ...
			 cout << "[C Binding] Object has been serialized as output." << endl << flush;
			 }
