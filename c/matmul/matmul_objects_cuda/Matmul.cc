	...
	if (argc != 4) {
		...
		if ((N <= 10) && (M <= 10)) {
			C.print();
                ...
                init_msecs = (((t_comp_start.tv_sec - t_init_start.tv_sec) * 1000000) + (t_comp_start.tv_usec - t_init_start.tv_usec))/1000;
		...
		cout << "Results for execution with GPU, N: " << N << ", M: " << M << endl;
