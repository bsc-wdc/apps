...
{
	 debug_printf("Detected task multiplyBlocks\n");
	 void *arrayObjs[27];
	 int found;
	 ...
	 debug_printf("Binding Value: %s (before %s)\n", block2_value,block2_oss.str().c_str());
		 arrayObjs[9] = &block2_value;
		 int param10 = 13;
		 arrayObjs[10] = &param10;
		 int param11 = 2;
		 ...
		 char *param15 = "null";
		 arrayObjs[15] = &param15;
		 char *param16 = "1.0";
		 arrayObjs[16] = &param16;
		 int param17 = 0;
		 arrayObjs[17] = &param17;
	 ...
	 debug_printf("Binding Value: %s (before %s)\n", block3_value,block3_oss.str().c_str());
		 arrayObjs[18] = &block3_value;
		 int param19 = 13;
		 arrayObjs[19] = &param19;
		 int param20 = 2;
		 arrayObjs[20] = &param20;
		 int param21 = 3;
		 arrayObjs[21] = &param21;
		 char *param22 = "null";
		 arrayObjs[22] = &param22;
		 char *param23 = "null";
		 arrayObjs[23] = &param23;
		 char *param24 = "null";
		 arrayObjs[24] = &param24;
		 char *param25 = "1.0";
		 arrayObjs[25] = &param25;
		 int param26 = 0;
		 arrayObjs[26] = &param26;


	 char *method_name = strdup("multiplyBlocks");
	 GS_ExecuteTask(0L, "NULL", "RETRY", 0, method_name, 0, 1, 0, 0, 0, 0, 0, 0, 3, (void**)arrayObjs);
